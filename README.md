...
<body>
  ...
  <script>
    // Sayfa geçişini sağlamak için
    function showPage() {
      const hash = window.location.hash;
      document.getElementById('home-page').style.display = (hash === "#image") ? "none" : "block";
      document.getElementById('image').style.display = (hash === "#image") ? "block" : "none";
    }
